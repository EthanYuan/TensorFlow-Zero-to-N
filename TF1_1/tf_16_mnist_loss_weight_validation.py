...
def main(_):
    ...
    accuracy_ = accuracy / 100.0
    scalar_accuracy = tf.summary.scalar('accuracy', accuracy_)
    ...
    for epoch in range(30):
        ...
        sum, _ = sess.run([merged, train_step], feed_dict={
        ...
        sum_accuracy = sess.run(
            scalar_accuracy,
            feed_dict={x: mnist.validation.images,
                       y_: mnist.validation.labels})

        validation_writer.add_summary(sum_accuracy, epoch)
