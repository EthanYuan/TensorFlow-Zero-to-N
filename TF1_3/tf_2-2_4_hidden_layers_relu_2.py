...
def main(_):
    ...
    W_2 = tf.Variable(tf.random_normal([784, 500]) / tf.sqrt(784.0/2))
    b_2 = tf.Variable(tf.random_normal([500]))
    z_2 = tf.matmul(x, W_2) + b_2
    a_2 = tf.nn.relu(z_2)

    W_3 = tf.Variable(tf.random_normal([500, 300]) / tf.sqrt(500.0/2))
    b_3 = tf.Variable(tf.random_normal([300]))
    z_3 = tf.matmul(a_2, W_3) + b_3
    a_3 = tf.nn.relu(z_3)

    W_4 = tf.Variable(tf.random_normal([300, 150]) / tf.sqrt(300.0/2))
    b_4 = tf.Variable(tf.random_normal([150]))
    z_4 = tf.matmul(a_3, W_4) + b_4
    a_4 = tf.nn.relu(z_4)

    W_5 = tf.Variable(tf.random_normal([150, 50]) / tf.sqrt(150.0/2))
    b_5 = tf.Variable(tf.random_normal([50]))
    z_5 = tf.matmul(a_4, W_5) + b_5
    a_5 = tf.nn.relu(z_5)

    W_6 = tf.Variable(tf.random_normal([50, 10]) / tf.sqrt(50.0))
